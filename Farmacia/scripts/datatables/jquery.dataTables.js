...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Demostrando 1 to 10 of 57 entradas") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Demostrando _START_ to _END_ of _TOTAL_ entradas
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "Demostrando _START_ to _END_ of _TOTAL_ entradas",
			 ...
			 *  @type string
			 *  @default Demostrando 0 to 0 of 0 entradas
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Demostrando 0 to 0 of 0 entradas",
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the 'Demostrando x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
