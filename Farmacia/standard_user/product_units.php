...
$titulopag="Unidad de los productos";
$titulo="Inkafarma";
$tituloModulo="Unidad de los productos";
//BOTONES
						...
						$pname = $row['name'];
                               print '<tr class="odd gradeX">
                                 ...
                                 <div class="alert alert-success">
										...
										<h3 style="color:green">No se encontro Unidades de Productos</h3>
										Todas las unidades de producto registradas por su administrador se mostrarán aquí.
									</div>
									</div>';
                                       }
