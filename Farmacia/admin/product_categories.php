                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <div class="content">
								...
								<div class="controls">
												<input type="text" id="basicinput" placeholder="Nombre de Categoria..." name="category" required class="span8"><button type="submit" class="btn">Agregar Categoria</button>
						...
						$pname = $row['name'];
                               print '<tr class="odd gradeX">
                                                ...
                                                <td>
                                                <a ';?> onclick="return confirm('¿Estas seguro que quieres eliminar la categoria <?php echo"$pname"; ?> ?');" <?php print 'href="action/delete_category.php?ref='.$pname.'" class="btn btn-small btn-danger">Borrar Categoria</a>
                                                </td>
