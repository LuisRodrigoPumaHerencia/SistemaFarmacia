...
$titulopag="Resultado de Busqueda";
$titulo="Inkafarma";
$tituloModulo="Resultado de Busqueda";
//BOTONES
...
<head>
    <head>
        ...
        <title><?php echo $titulopag;?>s</title>
                               ...
                               print '<tr class="odd gradeX">
												...
												<div class="dropdown">
													...
													<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
														...
														<li><a '; ?> onclick="return confirm('Estas seguro de eliminar el producto <?php echo $row['name']; ?> ?')" <?php print 'href="action/delete_product.php?ref='.$row['product_id'].'">Delete</a></li>
													</ul>
												</div>
											</div>
										</div>
                                 ...
                                 <div class="alert alert-success">
										...
										<h3 style="color:green">¡Producto no Encontrado!</h3>
