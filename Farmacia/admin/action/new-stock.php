...
if ($conn->query($sql) === TRUE) {
    header("location:../new_stock.php?in=El producto $product_name fue registrado");
} else {
    header("location:../new_stock.php?err=No se pudo registrar el producto $product_name");
}
