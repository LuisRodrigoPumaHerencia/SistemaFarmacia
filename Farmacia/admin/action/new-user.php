...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      header("location:../new_user.php?err=La dirección de correo electrónico debe ser única");
    }
} else {
  include '../../config/db_config.php';
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      header("location:../new_user.php?err=El número de teléfono debe ser único");
    }
} else {
