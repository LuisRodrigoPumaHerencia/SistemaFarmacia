                            ...
                            <div class="module">
                               ...
                               print '<tr class="odd gradeX">
											...
											<div class="controls">
												<div class="dropdown">
													...
													<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
														<li><a href="action/edit_send.php?ref='.$row['user_id'].'">Editar Usuario</a></li>
														<li><a '; ?> onclick="return confirm('¿Estas seguro de borrar al usuario <?php echo $row['fullname']; ?> ?')" <?php print 'href="action/delete_user.php?ref='.$row['user_id'].'">Borrar usuario</a></li>
													</ul>
												</div>
											</div>
										</div>
                                 ...
                                 <div class="alert alert-success">
										...
										Todos los usuarios registrados se mostrarán aquí.
									</div>
									</div>';
                                       }
