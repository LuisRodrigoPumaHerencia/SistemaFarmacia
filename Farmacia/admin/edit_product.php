...
$titulopag="Editar Producto";
$titulo="Inkafarma";
$tituloModulo="Editar Producto";
//BOTONES
								...
								?>
                                 <form class="form-horizontal row-fluid" action="action/update-stock.php" method="POST">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" placeholder="Nombre del Producto..." value="<?php echo"$pname"; ?>" name="product" required class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-append">
													<input type="number" placeholder="Precio de Compra" name="buyingprice" value="<?php echo"$pbp"; ?>"  required class="span8"><span class="add-on"><?php echo"$SEshopcurrency"; ?></span>
											...
											<div class="controls">
												<div class="input-append">
													<input type="number" placeholder="Precio de Venta" name="sellingprice" value="<?php echo"$psp"; ?>"   required class="span8"><span class="add-on"><?php echo"$SEshopcurrency"; ?></span>
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Nivel bajo de Stock</label>
											<div class="controls">
												<input type="number" id="basicinput" placeholder="Nivel bajo de Stock..." value="<?php echo"$psl"; ?>"  name="stocklevel" required class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="number" placeholder="Stock de de Apertura…" name="stock" value="<?php echo"$pos"; ?>"  required class="span8 tip">
											</div>
										</div>
										
										<div class="control-group">
											<label class="control-label" for="basicinput">Stock Actual</label>
											<div class="controls">
												<input type="number" placeholder="Stock Actual…" name="currentstock" value="<?php echo"$cst"; ?>"  required class="span8 tip"><br>
												<b style="color:red;">Cambie esto solo si está actualizando el producto</b>
											</div>
										</div>
											...
											<div class="controls">
												<input type="text" placeholder="Código de Barras" name="barcode" value="<?php echo"$pbc"; ?>"  required class="span8 tip">
											</div>
										</div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Categoria del Producto</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Unidad del Producto</label>
											<div class="controls">
