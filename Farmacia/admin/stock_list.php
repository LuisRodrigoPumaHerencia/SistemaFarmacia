...
$titulopag="Lista de Stock";
$titulo="Inkafarma";
$tituloModulo="Lista de Stock";
//BOTONES
                        ...
                        <div class="content">
                            <div class="module">
                               ...
                               print '<tr class="odd gradeX">
												...
												<td>
                                                    '.number_format($row['selling_price']).' PEN
                                                </td>
												<td>
                                                ...
                                                <td class="center">
                                              	<div class="controls">
												<div class="dropdown">
													<a class="dropdown-toggle btn" data-toggle="dropdown" href="#">Opcion <i class="icon-caret-down"></i></a>
													<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
														<li><a href="action/edit_send2.php?ref='.$row['product_id'].'">Editar</a></li>
														<li><a href="action/explore_send.php?ref='.$row['product_id'].'">Explorar</a></li>
														<li><a '; ?> onclick="return confirm('¿Estas seguro de eliminar <?php echo $row['name']; ?> ?')" <?php print 'href="action/delete_product.php?ref='.$row['product_id'].'">Borrar</a></li>
													</ul>
												</div>
											</div>
										</div>
