...
<div class="sidebar">
    <ul class="widget widget-menu unstyled">
        ...
        <li><a href="stock_list.php"><i class="menu-icon icon-shopping-cart"></i> Productos</a></li>
...
$titulopag="Unidad de Productos";
$titulo="Inkafarma";
$tituloModulo="Unidad de Productos";
//BOTONES
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <div class="content">
								...
								<div class="controls">
												<input type="text" id="basicinput" placeholder="Nombre de la unidad..." name="unit" required class="span8"><button type="submit" class="btn">Agregar Unidad</button>
                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
								 ...
								 $sql = "SELECT * FROM product_units WHERE shop = 'ALL' ORDER BY name";
						...
						$pname = $row['name'];
                               print '<tr class="odd gradeX">
                                                ...
                                                <td>
                                                <a ';?> onclick="return confirm('¿Estas seguro de borrar la unidad <?php echo"$pname"; ?> ?');" <?php print 'href="action/delete_unit.php?ref='.$pname.'" class="btn btn-small btn-danger">Borrar Unidad</a>
                                                </td>
